...
int main(int argc, char* argv[]) {
  ...
  std::string base_filename = "/mnt/scratch/wenqi/Faiss_experiments/bigann/bigann_base.bvecs";
  std::string query_filename = "/mnt/scratch/wenqi/Faiss_experiments/bigann/bigann_query.bvecs";
  std::string groundtruth_filename;
  size_t N_base;
  if (FLAGS_dbname == "SIFT1M") {
    groundtruth_filename = "/mnt/scratch/wenqi/Faiss_experiments/bigann/gnd/idx_1M.ivecs";
    N_base = 1e6;
  } else if (FLAGS_dbname == "SIFT10M") {
    groundtruth_filename = "/mnt/scratch/wenqi/Faiss_experiments/bigann/gnd/idx_10M.ivecs";
    N_base = 1e7;
  } else {
