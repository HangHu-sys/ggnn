...
int main(int argc, char* argv[]) {
  ...
  std::string base_filename = "/mnt/scratch/wenqi/Faiss_experiments/SPACEV/vectors_all.bin";
  std::string query_filename = "/mnt/scratch/wenqi/Faiss_experiments/SPACEV/query_10K.bin";
  std::string groundtruth_filename;
  size_t N_base;
  if (FLAGS_dbname == "SPACEV1M") {
    groundtruth_filename = "/mnt/scratch/wenqi/Faiss_experiments/SPACEV/gt_idx_1M.ibin";
    N_base = 1e6;
  } else if (FLAGS_dbname == "SPACEV10M") {
    groundtruth_filename = "/mnt/scratch/wenqi/Faiss_experiments/SPACEV/gt_idx_10M.ibin";
    N_base = 1e7;
  } else {
  ...
  //
  // dataset configuration (here: SPACEV1M)
  //
